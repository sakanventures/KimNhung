      ...
      <div className="mx-auto max-w-7xl px-4 pt-5 sm:px-6 lg:px-8">
        <div className="grid gap-4 lg:grid-cols-[1.55fr_1fr]">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-primary text-primary-foreground">
            <img
              src="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=1100&h=720&fit=crop&auto=format"
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1534482421-64566f976cfa?w=560&h=400&fit=crop&auto=format"
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1509440159596-0249088772ff?w=560&h=400&fit=crop&auto=format"
